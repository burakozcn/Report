...
struct CreateFinItem: AsyncMigration {
  func prepare(on database: Database) async throws {
    try await database.schema("finitem")
      ...
      .field("ddebit", .sql(raw: "numeric(21,2)"))
      .field("dcredit", .sql(raw: "numeric(21,2)"))
      .field("hdebit", .sql(raw: "numeric(21,2)"))
      .field("hcredit", .sql(raw: "numeric(21,2)"))
      .field("rdebit", .sql(raw: "numeric(21,2)"))
      .field("rcredit", .sql(raw: "numeric(21,2)"))
